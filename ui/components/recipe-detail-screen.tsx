          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-muted-foreground mb-3">
                Para ter uma margem de lucro saudável, sugerimos vender cada
                porção por:
              </p>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="text-right">
                      ...
                      <p className="text-xs text-muted-foreground">
                        (R$ {detail.ingredient.costPerUnit.toFixed(2)} / {unit})
                      </p>
                    </div>
                  </div>
                </Card>
          ...
          <div className="space-y-2 text-sm">
            <div className="flex justify-between">
              <span className="text-muted-foreground">
                Vendendo a R$ {suggestedPrice.toFixed(2)}:
              </span>
              <span className="font-semibold text-success">
                +R$ {(suggestedPrice - recipe.costPerServing).toFixed(2)} por
                porção
              </span>
            </div>
            <div className="flex justify-between pt-2 border-t border-border">
              <span className="text-muted-foreground">
                Lucro total ({recipe.servings} porções):
              </span>
              <span className="font-bold text-success text-base">
                R${" "}
                {(
                  (suggestedPrice - recipe.costPerServing) *
                  recipe.servings
                ).toFixed(2)}
              </span>
            </div>
